(() => {
  ...
  */
  ...
  // Symbol 비교
  let s1: symbol = Symbol('hello'); // 'hello'라는 설명을 가진 Symbol 생성
  let s2: symbol = Symbol('world'); // 'world'라는 설명을 가진 Symbol 생성
  let s3: symbol = Symbol('hello'); // 'hello'라는 설명을 가진 새로운 Symbol 생성
