(() => {
  ...
  */
  ...
  var maxNum: number = Number.MAX_VALUE; // number로 표현 가능한 최대값

  // JavaScript에서 정확하게 표현 가능한 최대 정수값 (9007199254740991, 약 9000조)
  // 이 값을 넘어가면 정확성이 보장되지 않음
  var maxSafeNum: number = Number.MAX_SAFE_INTEGER; // 정확한 정수의 최대값(9007199254740991, 약 9000조)
  ...
  var b1: bigint = 12345n;
  // Number.MAX_SAFE_INTEGER를 BigInt로 변환
  var b2: bigint = BigInt(maxSafeNum);
