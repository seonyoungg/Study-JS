(() => {
  ...
  */
  ...
  // ID 유효성 검사 예제
  var id: string = 'honkjsdhfkjshdfiuwyehrifu';
  // ID 길이가 4보다 작거나 12보다 큰 경우 invalid
  var invalidId: boolean = id.length < 4 || id.length > 12;
  ...
  console.log(null || 'guest'); // guest (앞의 값이 falsy)
  console.log(undefined || 'guest'); // guest (앞의 값이 falsy)
  console.log(0 || 30); // 30 (앞의 값이 falsy)
  console.log('' || 'guest'); // guest (앞의 값이 falsy)
