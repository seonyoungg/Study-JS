...
(() => {
    ...
    // 타입 가드 구문이 복잡하거나 여러번 재사용해야할 경우 타입 가드 함수를 작성
    // user is AdminUser => 구문의 의미는 isAdmin 함수가 true를 리턴할 경우 user의 type이 AdminUser가 된다는 의미미
    ...
    // function isUser(user : User | AdminUser | Guest){
